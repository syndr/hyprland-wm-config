...
<br>
  ...
  <a href="https://github.com/syndr/hyprland-wm-config/wiki"><kbd> <br> Вікі <br> </kbd></a>  
  <a href="https://github.com/syndr/hyprland-wm-config/discussions"><kbd> <br> Обговорення <br> </kbd></a>  
  <a href="https://github.com/syndr/hyprland-wm-config/wiki/Keybinds"><kbd> <br> Гарячі клавіші <br> </kbd></a>   
</div><br>
...
### 🎞️ Демо AGS Overview
- якщо вам цікаво, ось коротке демо AGS overview [Посилання на Videos (JaKooLit)](https://youtu.be/zY5SLNPBJTs)
...
### 📦 Що нового?
- Щоб легко відстежувати зміни, я оновлюватиму [Журнал змін](https://github.com/syndr/hyprland-wm-config/wiki/Changelogs). Скріншоти будуть додані, якщо зміни варті згадки!
...
- [`БІЛЬШЕ ІНФОРМАЦІЇ ТУТ`](https://github.com/syndr/hyprland-wm-config/wiki/Install_&_Update) 
> [!Примітака] 
...
- Я отримую величезну кількість повідомлень щодо оновлення dotfiles Hyprland від KooL. Я зробив велику примітку у [`ВІКІ`](https://github.com/syndr/hyprland-wm-config/wiki/Install_&_Update)
...
- Користувачі / власники Nvidia, після встановлення перевірте [`ЦЕ`](https://github.com/syndr/hyprland-wm-config/wiki/Notes_to_remember#--for-nvidia-gpu-users)
...
- перегляньте цю сторінку [Поширені запитання](https://github.com/syndr/hyprland-wm-config/wiki/FAQ) та [НЕРОЗВ’ЯЗАНІ ПРОБЛЕМИ](https://github.com/syndr/hyprland-wm-config/wiki/Known_Issues)
...
- Ще запитання? натисніть тут, щоб переглянути цю [ВІКІ](https://github.com/syndr/hyprland-wm-config/wiki/)
- Якщо вам потрібні старі конфігурації, вони зібрані в моєму репозиторії „Archive“. Дивіться [ТУТ](https://github.com/syndr/hyprland-wm-config-releases-Archive)

#### ⌨ Гарячі клавіші
- Гарячі клавіші [`КЛІКНІТЬ`](https://github.com/syndr/hyprland-wm-config/wiki/Keybinds)
...
#### ✍️ Внесок
- Хочете зробити внесок? Клікніть [`ТУТ`](https://github.com/syndr/hyprland-wm-config/blob/main/CONTRIBUTING.md) для посібника зі внесення внеску
...
Цей проект є форком [Hyprland-Dots від JaKooLit](https://github.com/JaKooLit/Hyprland-Dots).

Якщо ця конфігурація була вам корисною, будь ласка, розгляньте:
- Поставити зірку [оригінальному репозиторію](https://github.com/JaKooLit/Hyprland-Dots)
- Приєднатися до [Discord-серверу](https://discord.com/invite/kool-tech-world) JaKooLit
- Підтримати оригінального автора через [Ko-fi](https://ko-fi.com/jakoolit) або [Buy Me A Coffee](https://www.buymeacoffee.com/JaKooLit)
